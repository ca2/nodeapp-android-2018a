...
void fill_plasma4(AndroidBitmapInfo*  info,void*  pixels,double  t)
{
   uint32_t uiColor = 127 << 24 | (((unsigned char)(255.0 * (0.5 + sin(fmod(t / 1000.0,3.14159)) / 2.0))) << 8);
   int yy;
   for(yy = 0; yy < info->height; yy++) {
...
extern "C"
{
   ...
   JNIEXPORT void JNICALL Java_cc_ca2_androidapp_ApplicationView_applicationViewStart(JNIEnv * env,jobject  obj);
   JNIEXPORT void JNICALL Java_cc_ca2_androidapp_ApplicationView_applicationViewStop(JNIEnv * env,jobject  obj);
...
JNIEXPORT void JNICALL Java_cc_ca2_androidapp_ApplicationView_applicationViewUpdateBitmap(JNIEnv * env,jobject  obj,jobject bitmap,jlong  time_ms)
{
    ...
    fill_plasma4(&info, pixels, time_ms );
