...
ID3String id3::v2::getString(const ID3_Frame* frame, ID3_FieldID fldName)
{
  if (!frame)
  {
    return "";
  ...
  ID3String text(fp->GetRawText(), fp->Size());

  fp->SetEncoding(enc);
  return text;
}

ID3String id3::v2::getStringAtIndex(const ID3_Frame* frame, ID3_FieldID fldName,
                                 size_t nIndex)
{
  if (!frame)
  {
...
ID3String id3::v2::getFrameText(const ID3_TagImpl& tag, ID3_FrameID id)
{
  ID3_Frame* frame = tag.Find(id);
  return getString(frame, ID3FN_TEXT);
}

ID3_Frame* id3::v2::setFrameText(ID3_TagImpl& tag, ID3_FrameID id, ID3String text)
{
  ID3_Frame* frame = tag.Find(id);
  if (!frame)
  {
...
ID3String id3::v2::getArtist(const ID3_TagImpl& tag)
{
  ID3_Frame* frame = hasArtist(tag);
  return getString(frame, ID3FN_TEXT);
}

ID3_Frame* id3::v2::setArtist(ID3_TagImpl& tag, ID3String text)
{
  removeArtists(tag);
...
ID3String id3::v2::getAlbum(const ID3_TagImpl& tag)
{
  return getFrameText(tag, ID3FID_ALBUM);
}

ID3_Frame* id3::v2::setAlbum(ID3_TagImpl& tag, ID3String text)
{
...
ID3String id3::v2::getTitle(const ID3_TagImpl& tag)
{
  return getFrameText(tag, ID3FID_TITLE);
}

ID3_Frame* id3::v2::setTitle(ID3_TagImpl& tag, ID3String text)
{
...
ID3String id3::v2::getYear(const ID3_TagImpl& tag)
{
  return getFrameText(tag, ID3FID_YEAR);
}

ID3_Frame* id3::v2::setYear(ID3_TagImpl& tag, ID3String text)
{
...
ID3String id3::v2::getV1Comment(const ID3_TagImpl& tag)
{
  ID3_Frame* frame;
  (frame = tag.Find(ID3FID_COMMENT, ID3FN_DESCRIPTION, STR_V1_COMMENT_DESC)) ||
  (frame = tag.Find(ID3FID_COMMENT, ID3FN_DESCRIPTION, ""                 )) ||
...
ID3String id3::v2::getComment(const ID3_TagImpl& tag, ID3String desc)
{
  ID3_Frame* frame = tag.Find(ID3FID_COMMENT, ID3FN_DESCRIPTION, desc.c_str());
  return getString(frame, ID3FN_TEXT);
}

ID3_Frame* id3::v2::setComment(ID3_TagImpl& tag, ID3String text, ID3String desc,
                               ID3String lang)
{
  ...
  for (ID3_TagImpl::iterator iter = tag.begin(); iter != tag.end(); ++iter)
  {
    ...
    {
      ID3String tmpDesc = getString(frame, ID3FN_DESCRIPTION);
      if (tmpDesc == desc)
      {
...
size_t id3::v2::removeComments(ID3_TagImpl& tag, ID3String desc)
{
  size_t numRemoved = 0;
...
ID3String id3::v2::getTrack(const ID3_TagImpl& tag)
{
...
{
  ID3_Frame* frame = NULL;
  ID3String track = toString((size_t)trk);
  if (ttl > 0)
  {
    track += "/";
...
ID3String id3::v2::getGenre(const ID3_TagImpl& tag)
{
...
ID3String id3::v2::getLyrics(const ID3_TagImpl& tag)
{
  return getFrameText(tag, ID3FID_UNSYNCEDLYRICS);
}

ID3_Frame* id3::v2::setLyrics(ID3_TagImpl& tag, ID3String text, ID3String desc,
                              ID3String lang)
{
  ID3_Frame* frame = NULL;
  // See if there is already a comment with this description
...
ID3String id3::v2::getLyricist(const ID3_TagImpl& tag)
{
  return getFrameText(tag, ID3FID_LYRICIST);
}

ID3_Frame* id3::v2::setLyricist(ID3_TagImpl& tag, ID3String text)
{
...
ID3_Frame* id3::v2::hasSyncLyrics(const ID3_TagImpl& tag, ID3String lang, ID3String desc)
{
  ID3_Frame* frame=NULL;
...
ID3_Frame* id3::v2::setSyncLyrics(ID3_TagImpl& tag, BString data,
                                  ID3_TimeStampFormat format, ID3String desc,
                                  ID3String lang, ID3_ContentType type)
{
  ID3_Frame* frame = NULL;
...
BString id3::v2::getSyncLyrics(const ID3_TagImpl& tag, ID3String lang, ID3String desc)
{
