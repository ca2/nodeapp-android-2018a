...
public:
  ...
  dami::ID3String  GetText() const;
  dami::ID3String  GetTextItem(size_t) const;
  size_t        SetText(dami::ID3String);
  size_t        AddText(dami::ID3String);
...
private:
  size_t        SetText_i(dami::ID3String);
  size_t        AddText_i(dami::ID3String);
...
private:
  ...
  dami::ID3String        _text;        // for ascii strings
  uint32              _integer;     // for numbers

  strsize             _fixed_size;  // for fixed length fields (0 if not)
