...
public:
  ...
  dami::ID3String GetFileName() const { return _file_name; }

  ID3_Frame* Find(ID3_FrameID id) const;
  ID3_Frame* Find(ID3_FrameID id, ID3_FieldID fld, uint32 data) const;
  ID3_Frame* Find(ID3_FrameID id, ID3_FieldID fld, dami::ID3String) const;
  ID3_Frame* Find(ID3_FrameID id, ID3_FieldID fld, dami::WString) const;
  ID3_Frame* Find(ID3_FrameID id,ID3_FieldID fld,const char * psz) const { return Find(id,fld, dami::ID3String(psz));  }
  ID3_Frame* Find(ID3_FrameID id,ID3_FieldID fld,const wchar_t * pwsz) const { return Find(id,fld,w_to_8(pwsz)); }
...
protected:
  ...
  void       ParseFile();
  void       ParseReader(ID3_Reader &reader,bool bSeekable=true); // if easily Randomly bSeekable, search tags at the end, otherwise only at the beginning
...
private:
  ...
  dami::ID3String _file_name;       // name of the file we are linked to
