...
bool id3::v1::parse(ID3_TagImpl& tag, ID3_Reader& reader)
{
  ...
  //file.seekg(-static_cast<long>(ID3_V1_LEN), file::seek_current);
  ...
  ID3String field = io::readText(reader, ID3_V1_LEN_ID);
  ...
  ID3String title = io::readTrailingSpaces(reader, ID3_V1_LEN_TITLE);
  ...
  ID3D_NOTICE("id3::v1::parse: read bytes: " << reader.getCur() - beg);
  ID3String artist = io::readTrailingSpaces(reader, ID3_V1_LEN_ARTIST);
  ...
  ID3D_NOTICE("id3::v1::parse: read bytes: " << reader.getCur() - beg);
  ID3String album = io::readTrailingSpaces(reader, ID3_V1_LEN_ALBUM);
  ...
  ID3D_NOTICE("id3::v1::parse: read bytes: " << reader.getCur() - beg);
  ID3String year = io::readTrailingSpaces(reader, ID3_V1_LEN_YEAR);
  ...
  ID3D_NOTICE("id3::v1::parse: read bytes: " << reader.getCur() - beg);
  ID3String comment = io::readTrailingSpaces(reader, ID3_V1_LEN_COMMENT-2);
