...
namespace android
{
   ...
   font* PASCAL font::from_handle(::ca2::application * papp, HFONT hFont)
   {
      return dynamic_cast < font * > (::android::graphics_object::from_handle(papp, hFont));
   }
   ...
   void font::construct(const ::ca2::font & fontParam)
      {
         class font & font = const_cast < ::android::font & > (dynamic_cast < const ::android::font & > (fontParam));
         if(get_handle() != NULL)
            delete_object();
   ...
   /////////////////////////////////////////////////////////////////////////////
   // out-of-line ::ca2::brush, font, etc. helpers

   // nPointSize is actually scaled 10x
   BOOL font::CreatePointFont(int nPointSize, const char * lpszFaceName, ::ca2::graphics * pgraphics)
   {
   ...
   BOOL font::CreatePointFontIndirect(const LOGFONT* lpLogFont, ::ca2::graphics * pgraphics)
   {
      ...
      if (pgraphics != NULL)
      {
         ...
         ASSERT((dynamic_cast<::android::graphics * >(pgraphics))->get_handle2() != NULL);
         hDC = (dynamic_cast<::android::graphics * >(pgraphics))->get_handle2();
      }
      else
         hDC = ::GetDC(NULL);
