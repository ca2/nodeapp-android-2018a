...
namespace android
{
   ...
   CLASS_DECL_ANDROID void dib::s_initialize()
   {
      double dCos;
      double dSin;
      double d32 = (1U << 31);
   ...
   {
      ::ca2::bitmap * pbitmap = (dynamic_cast<::android::graphics * >(pdc))->GetCurrentBitmap();
      if(pbitmap == NULL)
         return FALSE;
      BITMAP bm;
   ...
   bool dib::to(::ca2::graphics * pgraphics, point pt, class size size, point ptSrc)
   {
      return SetDIBitsToDevice(
         (dynamic_cast<::android::graphics * >(pgraphics))->get_handle1(),
         pt.x, pt.y,
         size.cx, size.cy,
