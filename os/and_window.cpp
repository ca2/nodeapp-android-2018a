...
//         ::radix::object* p=NULL;
   ...
   void window::dump(dump_context & dumpcontext) const
   {
      ...
      ::ca2::window * pWnd = ::win::window::FromHandlePermanent(get_handle());
      if (pWnd != this)
      ...
      case AfxSig_CTLCOLOR:
         {
            ...
            ::ca2::window * pWnd = ::win::window::FromHandlePermanent(wndTemp.get_handle());
            if (pWnd == NULL)
            {
               pWnd = &wndTemp;
            }
...
//      int nCode = pNMHDR->code;
   ...
   /* trans HWND CLASS_DECL_ANDROID AfxGetParentOwner(::user::interaction * hWnd)
   {
      ...
      ::ca2::window * pWnd = ::win::window::FromHandlePermanent(hWnd);
      if (pWnd != NULL)
      ...
      WPARAM wParam, LPARAM lParam, BOOL bDeep, BOOL bOnlyPerm)
   {
         ...
         hWndChild = ::GetNextWindow(hWndChild, GW_HWNDNEXT))
      {
         ...
         if (bOnlyPerm)
         {
            ::ca2::window * pWnd = ::win::window::FromHandlePermanent(hWndChild);
            if (pWnd != NULL)
            {
...
#pragma pop_macro("SendMessage")
   ...
   ::user::interaction * window::set_capture(::user::interaction* pinterface)
   {
      ...
      return dynamic_cast < ::ca2::window * > (::win::window::from_handle(::SetCapture(get_handle())));
   }
...
*/
  ...
  /*  void CMDIFrameWnd::MDIActivate(::user::interaction* pWndActivate)
   ...
   CLASS_DECL_ANDROID LRESULT AfxCallWndProc(::user::interaction * pinteraction, HWND hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
   {
      ...
      ::ca2::smart_pointer < ::user::win::message::base > spbase;
      ...
      case WM_INITDIALOG:
         {
            DWORD dwStyle;
            rect rectOld;
            ::ca2::window * pWnd = ::win::window::from_handle(hWnd);
