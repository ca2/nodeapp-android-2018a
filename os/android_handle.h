...
//      Use ::android::window::from_handle, ::android::graphics::from_handle, etc.
...
public:
   ...
   //::ca2::type_info m_pClass;
   //size_t m_nOffset;       // offset of handles in the object
   //int m_nHandles;         // 1 or 2 (for ::ca2::graphics_sp)
...
class CLASS_DECL_ANDROID hwnd_map :
   public handle_map < ::android::hwnd_handle, ::android::window >
{
public:
};

class CLASS_DECL_ANDROID hdc_map :
   public handle_map < ::android::hdc_handle, ::android::graphics >
{
public:
};

class hgdiobj_map :
   public handle_map < ::android::hgdiobj_handle, ::android::graphics_object >
{
public:
};
...
CLASS_DECL_ANDROID hwnd_map * PASCAL afxMapHWND(BOOL bCreate = FALSE);
CLASS_DECL_ANDROID himagelist_map * PASCAL afxMapHIMAGELIST(BOOL bCreate = FALSE);
CLASS_DECL_ANDROID hdc_map * PASCAL afxMapHDC(BOOL bCreate = FALSE);
CLASS_DECL_ANDROID hgdiobj_map * PASCAL afxMapHGDIOBJ(BOOL bCreate = FALSE);
CLASS_DECL_ANDROID hmenu_map * PASCAL afx_map_HMENU(BOOL bCreate = FALSE);
