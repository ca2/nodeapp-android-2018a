...
namespace android
{
   ...
   { 
      return dynamic_cast < palette * > (::android::graphics_object::from_handle(papp, hPalette)); 
   }
   BOOL palette::CreatePalette(LPLOGPALETTE lpLogPalette)
   { return Attach(::CreatePalette(lpLogPalette)); }
   BOOL palette::CreateHalftonePalette(::ca2::graphics * pgraphics)
   { ASSERT(pgraphics != NULL && (dynamic_cast<::android::graphics * >(pgraphics))->get_handle1() != NULL); return Attach(
   ::CreateHalftonePalette((dynamic_cast<::android::graphics * >(pgraphics))->get_handle1())); }
