...
/*BOOL CLASS_DECL_ANDROID AfxWinInit(HINSTANCE hInstance, HINSTANCE hPrevInstance,
...
UINT CLASS_DECL_ANDROID AfxGetFileName(const char * lpszPathName, __out_ecount_opt(nMax) LPTSTR lpszTitle, UINT nMax)
{
