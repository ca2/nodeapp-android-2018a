...
class CLASS_DECL_ANDROID thread_slot_data
{
public:
   thread_slot_data();
...
class CLASS_DECL_ANDROID __NOVTABLE no_track_object
{
public:
#undef new
...
class CLASS_DECL_ANDROID __NOVTABLE thread_local_object
{
public:
// Attributes
...
class CLASS_DECL_ANDROID __NOVTABLE process_local_object
{
public:
// Attributes
   no_track_object* get_data(no_track_object* (* pfnCreateObject)());
...
#define EXTERN_THREAD_LOCAL(class_name, ident_name) \
   extern CLASS_DECL_ANDROID thread_local<class_name> ident_name;
...
void CLASS_DECL_ANDROID AfxInitLocalData(HINSTANCE hInstInit);
void CLASS_DECL_ANDROID AfxTermLocalData(HINSTANCE hInstTerm, BOOL bAll = FALSE);
void CLASS_DECL_ANDROID AfxTlsAddRef();
void CLASS_DECL_ANDROID AfxTlsRelease();
