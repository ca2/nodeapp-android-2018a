...
class CLASS_DECL_ANDROID thread_local_storage
{
public:
...
class CLASS_DECL_ANDROID no_track_object
{
public:
#undef new
...
class CLASS_DECL_ANDROID process_local_object
{
public:
...
#define EXTERN_THREAD_LOcaL(class_name, ident_name, slot) \
   extern CLASS_DECL_ANDROID thread_local<class_name, slot> ident_name;
...
void CLASS_DECL_ANDROID __init_local_data(HINSTANCE hInstInit);
void CLASS_DECL_ANDROID __term_local_data(HINSTANCE hInstTerm, bool bAll = FALSE);
void CLASS_DECL_ANDROID __tls_add_ref();
void CLASS_DECL_ANDROID __tls_release();
