...
namespace android
{
   ...
   rgn* PASCAL rgn::from_handle(::ca2::application * papp, HRGN hRgn)
   { 
      return dynamic_cast < rgn * > (::android::graphics_object::from_handle(papp, hRgn));
   }
   ...
   BOOL rgn::CreateFromPath(::ca2::graphics * pgraphics)
   { ASSERT(pgraphics != NULL); return Attach(::PathToRegion((dynamic_cast<::android::graphics * >(pgraphics))->get_handle1())); }
