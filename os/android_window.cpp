...
namespace android
{
   ...
   {
      return dynamic_cast <::ca2::window *>(from_handle((HWND) pdata));
   }
   ...
   __STATIC BOOL CLASS_DECL_ANDROID _AfxModifyStyle(HWND hWnd, int nStyleOffset,
...
//         ::radix::object* p=NULL;
         ...
         // the HWND with a window object by using ::android::window::from_handle.
         //
   ...
   { ASSERT(::IsWindow((HWND)get_os_data())); return  ::android::window::from_handle(::GetAncestor((HWND)get_os_data(), gaFlags)); }
   ...
   {
      ASSERT(::IsWindow((HWND)get_os_data()));
      return ::PrintWindow((HWND)get_os_data(), (HDC)(dynamic_cast<::android::graphics * >(pgraphics))->get_os_data(), nFlags);
   }
...
//      BOOL b;
   ...
   BOOL window::OnWndMsg(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pResult)
   {
      ...
      if (message == WM_ACTIVATE)
         _AfxHandleActivate(this, wParam, ::android::window::from_handle((HWND)lParam));
   ...
   LDispatch:
      ...
      case AfxSig_v_u_W:
         (this->*mmf.pfn_v_u_W)(static_cast<UINT>(wParam),
            ::android::window::from_handle(reinterpret_cast<HWND>(lParam)));
         break;
      ...
      case AfxSig_b_W_uu:
         lResult = (this->*mmf.pfn_b_W_u_u)(::android::window::from_handle(reinterpret_cast<HWND>(wParam)),
            LOWORD(lParam), HIWORD(lParam));
         break;

      case AfxSig_b_W_COPYDATASTRUCT:
         lResult = (this->*mmf.pfn_b_W_COPYDATASTRUCT)(
            ::android::window::from_handle(reinterpret_cast<HWND>(wParam)),
      ...
      case AfxSig_i_u_W_u:
         lResult = (this->*mmf.pfn_i_u_W_u)(LOWORD(wParam),
            ::android::window::from_handle(reinterpret_cast<HWND>(lParam)), HIWORD(wParam));
         break;
      ...
      case AfxSig_i_W_uu:
         lResult = (this->*mmf.pfn_i_W_u_u)(::android::window::from_handle(reinterpret_cast<HWND>(wParam)),
            LOWORD(lParam), HIWORD(lParam));
         break;
      ...
      case AfxSig_v_W_v:
         (this->*mmf.pfn_v_W)(::android::window::from_handle(reinterpret_cast<HWND>(wParam)));
         break;

      case AfxSig_v_v_W:
         (this->*mmf.pfn_v_W)(::android::window::from_handle(reinterpret_cast<HWND>(lParam)));
         break;

      case AfxSig_v_W_uu:
         (this->*mmf.pfn_v_W_u_u)(::android::window::from_handle(reinterpret_cast<HWND>(wParam)), LOWORD(lParam),
            HIWORD(lParam));
         break;
      ...
      case AfxSig_v_W_p:
         {
            point point(lParam);
            (this->*mmf.pfn_v_W_p)(::android::window::from_handle(reinterpret_cast<HWND>(wParam)), point);
         }
         break;

      case AfxSig_v_W_h:
         (this->*mmf.pfn_v_W_h)(::android::window::from_handle(reinterpret_cast<HWND>(wParam)),
               reinterpret_cast<HANDLE>(lParam));
         break;
...
//      int nCode = pNMHDR->code;
   ...
   /* trans HWND CLASS_DECL_ANDROID AfxGetParentOwner(::user::interaction * hWnd)
   {
   ...
   ::ca2::window * PASCAL window::GetSafeOwner(::ca2::window * pParent, HWND* pWndTop)
   {
   ...
   */
   ...
   void window::WalkPreTranslateTree(HWND hWndStop, ::ca2::signal_object * pobj)
   {
...
/*   guie_message_wnd::guie_message_wnd(::ca2::application * papp) :
   ...
   {
      return ((HWND) WIN_WINDOW(const_cast < ::ca2::window * > (&wnd))->get_handle()) == get_handle();
   }
...
int window::GetCheckedRadioButton(int nIDFirstButton, int nIDLastButton)
{
   ...
   return 0; // invalid ID
    ...
    {
       ASSERT(::IsWindow(get_handle()));
       return ::android::window::from_handle(::GetNextDlgGroupItem(get_handle(), (HWND) pWndCtl->get_os_data(), bPrevious));
    }

    ::ca2::window * window::GetNextDlgTabItem(::ca2::window * pWndCtl, BOOL bPrevious) const
    {
       ASSERT(::IsWindow(get_handle()));
       return ::android::window::from_handle(::GetNextDlgTabItem(get_handle(), (HWND) pWndCtl->get_os_data(), bPrevious));
    }
    ...
    ::ca2::window * window::FindWindowEx(HWND hwndParent, HWND hwndChildAfter, const char * lpszClass, const char * lpszWindow)
    ...
    {
       ASSERT(::IsWindow(get_handle()));
       return ::android::window::from_handle(::SetParent(get_handle(), (HWND) pWndNewParent->get_os_data()));
    }
...
*/
  ...
  /*  void CMDIFrameWnd::MDIActivate(::user::interaction* pWndActivate)
   ...
   CLASS_DECL_ANDROID LRESULT AfxCallWndProc(::user::interaction * pinteraction, HWND hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
   {
      _AFX_THREAD_STATE* pThreadState = _afxThreadState.get_data();
   ...
   LRESULT CALLBACK _AfxCbtFilterHook(int code, WPARAM wParam, LPARAM lParam)
   {
      ...
      if (pWndInit != NULL || (!(lpcs->style & WS_CHILD) && !bContextIsDLL))
      {
         ...
         if (pWndInit != NULL)
         {
            ...
            pWndInit->m_pthread = dynamic_cast < ::radix::thread * > (::android::get_thread());
   ...
   try
   {
      ...
      case WM_ACTIVATE:
         _AfxHandleActivate(::android::window::from_handle(hWnd), wParam,
            ::android::window::from_handle((HWND)lParam));
         break;
