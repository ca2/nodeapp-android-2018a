...
__STATIC void CLASS_DECL_ANDROID _AfxPreInitDialog(
   ::user::interaction * pWnd, LPRECT lpRectOld, DWORD* pdwStyleOld);
__STATIC void CLASS_DECL_ANDROID _AfxPostInitDialog(
   ::user::interaction * pWnd, const RECT& rectOld, DWORD dwStyleOld);
LRESULT CALLBACK
_AfxActivationWndProc(oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam);
...
namespace android
{
   ...
   window::window(::ca2::application * papp) :
      ca2(papp),
   ...
   ::ca2::window * window::from_os_data(void * pdata)
   {
      return dynamic_cast <::ca2::window *>(from_handle((oswindow) pdata));
   }
   ...
   __STATIC BOOL CLASS_DECL_ANDROID _AfxModifyStyle(oswindow hWnd, int nStyleOffset,
   ...
   void window::_001InstallMessageHandling(::user::android::message::dispatch * pinterface)
   {
   ...
   {
      SCAST_PTR(::user::android::message::show_window, pshowwindow, pobj);
      if(GetParent() == NULL)
      {
         m_bVisible = true;
      }
   ...
   void window::_001OnDestroy(::ca2::signal_object * pobj)
   {
      UNREFERENCED_PARAMETER(pobj);
      Default();
      ::android::window_draw * pdraw = dynamic_cast < ::android::window_draw * > (System.get_twf());
      if(pdraw != NULL)
      {
...
//         ::ca2::object* p=NULL;
         ...
         //ASSERT(dynamic_cast < ::ca2::window * > (p) == this);   // must be us
   ...
   void window::dump(dump_context & dumpcontext) const
   {
      ...
      ::ca2::window * pWnd = ::android::window::FromHandlePermanent(get_handle());
      if (pWnd != this)
      ...
      dumpcontext << "\nrect = " << rect;
      dumpcontext << "\nparent ::ca2::window * = " << (void *)((::ca2::window *) this)->GetParent();
   ...
   BOOL window::DestroyWindow()
   {
      ...
      if (get_handle() != NULL)
      {
         ...
         if(pMap != NULL)
         {
            pWnd = dynamic_cast < ::ca2::window * > (pMap->lookup_permanent(get_handle()));
      #ifdef DEBUG
            hWndOrig = get_handle();
      #endif
         }
   ...
   #ifdef DEBUG
            ::ca2::window * pWndPermanent = dynamic_cast < ::ca2::window * > (pMap->lookup_permanent(hWndOrig));;
   ...
   BOOL window::GetWindowInfo(PWINDOWINFO pwi) const
   {
      ...
      return ::GetWindowInfo((oswindow)get_os_data(), pwi);
   }

    ::ca2::window * window::GetAncestor(UINT gaFlags) const
   { ASSERT(::IsWindow((oswindow)get_os_data())); return  ::android::window::from_handle(::GetAncestor((oswindow)get_os_data(), gaFlags)); }
    ...
    BOOL window::GetScrollBarInfo(LONG idObject, PSCROLLBARINFO psbi) const
   {
      ASSERT(::IsWindow((oswindow)get_os_data()));
      ASSERT(psbi != NULL);
      return ::GetScrollBarInfo((oswindow)get_os_data(), idObject, psbi);
   }
    ...
    BOOL window::GetTitleBarInfo(PTITLEBARINFO pti) const
   {
      ASSERT(::IsWindow((oswindow)get_os_data()));
      ASSERT(pti != NULL);
      return ::GetTitleBarInfo((oswindow)get_os_data(), pti);
   }

    BOOL window::AnimateWindow(DWORD dwTime, DWORD dwFlags)
   {
      ASSERT(::IsWindow((oswindow)get_os_data()));
      return ::AnimateWindow((oswindow)get_os_data(), dwTime, dwFlags);
   }
   ...
   {
      ASSERT(::IsWindow((oswindow)get_os_data()));
      return ::SetLayeredWindowAttributes((oswindow)get_os_data(), crKey, bAlpha, dwFlags);
   }
   ...
   {
      ASSERT(::IsWindow((oswindow)get_os_data()));
      return ::GetLayeredWindowAttributes((oswindow)get_os_data(), pcrKey, pbAlpha, pdwFlags);
   }

    BOOL window::PrintWindow(::ca2::graphics * pgraphics, UINT nFlags) const
   {
      ASSERT(::IsWindow((oswindow)get_os_data()));
      return ::PrintWindow((oswindow)get_os_data(), (HDC)(dynamic_cast<::android::graphics * >(pgraphics))->get_os_data(), nFlags);
   }
...
/*      application* pApp = &System;
   ...
   {
      if(commandroid_target_interface::_001OnCmdMsg(pcmdmsg))
         return TRUE;
...
//      BOOL b;
      ...
      commandroid_target * pcmdtarget = dynamic_cast < commandroid_target * > (this);
      return pcmdtarget->commandroid_target::_001OnCmdMsg(pcmdmsg);
   }
   ...
   void window::_002OnDraw(::ca2::signal_object * pobj)
   {
      ...
      (WPARAM)((dynamic_cast<::android::graphics * >(pdc->m_pdc))->get_os_data()), (LPARAM)(PRF_CHILDREN | PRF_CLIENT));
   }
   ...
   void window::message_handler(::ca2::signal_object * pobj)
   {
      ...
      else if(pbase->m_uiMessage == CA2M_BERGEDGE)
      {
         ...
         {
            ::ca2::application ** ppapp= (::ca2::application **) pbase->m_lparam;
            *ppapp = get_app();
            pbase->m_bRet = true;
            return;
         }
         ...
         pbase->m_uiMessage == WM_MOUSEMOVE)
      {
         ...
         ::user::android::message::mouse * pmouse = (::user::android::message::mouse *) pbase;
   ...
   restart_mouse_hover_check:
         ...
         pbase->m_uiMessage == WM_CHAR)
      {
         ...
         ::user::android::message::key * pkey = (::user::android::message::key *) pbase;
   ...
   BOOL window::OnWndMsg(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pResult)
   {
      ...
      if (message == WM_ACTIVATE)
         _AfxHandleActivate(this, wParam, ::android::window::from_handle((oswindow)lParam));
      ...
      case AfxSig_CTLCOLOR:
         {
            ...
            ::ca2::window * pWnd = ::android::window::FromHandlePermanent(wndTemp.get_handle());
            if (pWnd == NULL)
            {
               pWnd = &wndTemp;
            }
...
//      int nCode = pNMHDR->code;
   ...
   /* trans oswindow CLASS_DECL_ANDROID AfxGetParentOwner(::user::interaction * hWnd)
   {
      // check for permanent-owned window first
      ::ca2::window * pWnd = ::android::window::FromHandlePermanent(hWnd);
      if (pWnd != NULL)
   ...
   void window::ActivateTopParent()
   {
      ...
      ::ca2::window * pActiveWnd = GetForegroundWindow();
   ...
   ::ca2::window * PASCAL window::GetSafeOwner(::ca2::window * pParent, oswindow* pWndTop)
   {
   ...
   void PASCAL window::SendMessageToDescendants(oswindow hWnd, UINT message,
      WPARAM wParam, LPARAM lParam, BOOL bDeep, BOOL bOnlyPerm)
   {
         ...
         hWndChild = ::GetNextWindow(hWndChild, GW_HWNDNEXT))
      {
         ...
         if (bOnlyPerm)
         {
            ::ca2::window * pWnd = ::android::window::FromHandlePermanent(hWndChild);
            if (pWnd != NULL)
            {
   ...
   */
   ...
   void window::WalkPreTranslateTree(oswindow hWndStop, ::ca2::signal_object * pobj)
   {
      ...
      for (oswindow hWnd = pbase->m_hwnd; hWnd != NULL; hWnd = ::GetParent(hWnd))
      {
         ::ca2::window * pWnd = ::android::window::FromHandlePermanent(hWnd);
         if (pWnd != NULL)
         {
   ...
   BOOL PASCAL window::ReflectLastMsg(oswindow hWndChild, LRESULT* pResult)
   {
      ...
      ::ca2::window * pWnd = dynamic_cast < ::ca2::window * > (pMap->lookup_permanent(hWndChild));
...
//      int iCount = wndaApp.get_count();
   ...
   /*         else if(::GetWindowLong(wndaApp[j], GWL_EXSTYLE) & WS_EX_LAYERED)
            ...
            else
            {
               ...
               ::ca2::rgn_sp rgnWindow(get_app());
               rgnWindow->CreateRectRgnIndirect(rectWindow);
               ::ca2::rgn_sp rgnIntersect(get_app());
         ...
         for(int j = wndaApp.get_upper_bound(); j >= 0; j--)
         {
            ...
            {
               ::ca2::window * pwnd = dynamic_cast < ::ca2::window * > (window::FromHandlePermanent(hWnd));
               if(pwnd == NULL)
               {
   ...
   void window::_001OnPaint(::ca2::signal_object * pobj)
   {
      ...
      try
      {
         ...
         if((dynamic_cast<::android::graphics * >(pdc))->get_os_data() == NULL
         || (dynamic_cast<::android::graphics * >(pdc))->get_handle2() == NULL)
            return;
...
//      DWORD dw = ::GetLastError();
   ...
   void window::_001Print(::ca2::graphics * pgraphics)
   {
   ...
   void window::OnEnterIdle(UINT /*nWhy*/, ::ca2::window * /*pWho*/)
   {
...
//         TRACE(::ca2::trace::category_AppMsg, 0, "Warning: hDC is NULL in window::GrayCtlColor; WM_CTLCOLOR not processed.\n");
   ...
   void window::UpdateDialogControls(commandroid_target* pTarget, BOOL bDisableIfNoHndler)
   {
   ...
   int window::RunModalLoop(DWORD dwFlags)
   {
      ...
      int iLevel = m_iModal;
      oprop(string("RunModalLoop.thread(") + ::ca2::str::itoa(iLevel) + ")") = System.GetThread();
      m_iModalCount++;

      m_iaModalThread.add(::GetCurrentThreadId());
      ::ca2::application * pappThis1 = dynamic_cast < ::ca2::application * > (m_pthread->m_p);
      ::ca2::application * pappThis2 = dynamic_cast < ::ca2::application * > (m_pthread);
...
ExitModal:
   ...
   void window::EndAllModalLoops(int nResult)
   {
      ...
      if(m_iModalCount > 0)
      {
         ...
         {
            ::ca2::thread * pthread = oprop(string("RunModalLoop.thread(") + ::ca2::str::itoa(i) + ")").ca2 < ::ca2::thread > ();
            try
            {
   ...
   BOOL window::SubclassWindow(oswindow hWnd)
   {
      ...
      {
         TRACE(::ca2::trace::category_AppMsg, 0, "Error: Trying to use SubclassWindow with incorrect window\n");
   ...
   #endif
      ::user::android::message::size size(get_app());
      _001OnSize(&size);
      return TRUE;
   }

   BOOL window::SubclassDlgItem(UINT nID, ::ca2::window * pParent)
   {
      ASSERT(pParent != NULL);
...
/*   view_update_hint::view_update_hint(::ca2::application * papp) :
      ca2(papp)
   {
   }
*/
...
/*   guie_message_wnd::guie_message_wnd(::ca2::application * papp) :
      ca2(papp)
   {
      m_pguieForward = NULL;
   }
   ...
   {
      return ((oswindow) WIN_WINDOW(const_cast < ::ca2::window * > (&wnd))->get_handle()) == get_handle();
   }
...
#pragma pop_macro("SendMessage")
   ...
   ::ca2::graphics * window::GetDC()
   {
      if(get_handle() == NULL)
      {
         return ::android::graphics::from_handle(::GetDC(NULL));
      }
      else
      {
         return ::android::graphics::from_handle(::GetDC(get_handle()));
      }
   }
   ...
   {
      ASSERT(::IsWindow(get_handle()));
      return ::android::graphics::from_handle(::GetWindowDC(get_handle()));
   }

   int window::ReleaseDC(::ca2::graphics * pgraphics)
   {
      if(get_handle() == NULL)
      {
         return ::ReleaseDC(NULL, (dynamic_cast<::android::graphics * >(pgraphics))->get_handle1());
      }
      else
      {
         return ::ReleaseDC(get_handle(), (dynamic_cast<::android::graphics * >(pgraphics))->get_handle1());
      }
   }
   ...
   int window::GetUpdateRgn(::ca2::rgn* pRgn, BOOL bErase)
   {
      ASSERT(::IsWindow(get_handle()));
   ...
   void window::InvalidateRgn(::ca2::rgn* pRgn, BOOL bErase)
   {
      ASSERT(::IsWindow(get_handle()));
    ...
    void window::ValidateRgn(::ca2::rgn* pRgn)
   ...
   ::user::interaction * window::GetDescendantWindow(id id)
   {
    ...
    ::ca2::graphics * window::GetDCEx(::ca2::rgn* prgnClip, DWORD flags)
      { ASSERT(::IsWindow(get_handle())); return ::android::graphics::from_handle(::GetDCEx(get_handle(), (HRGN)prgnClip->get_os_data(), flags)); }
    ...
    BOOL window::RedrawWindow(LPCRECT lpRectUpdate, ::ca2::rgn* prgnUpdate, UINT flags)
    {
    ...
    BOOL window::DrawCaption(::ca2::graphics * pgraphics, LPCRECT lprc, UINT uFlags)
      { ASSERT(::IsWindow(get_handle())); return (BOOL)::DrawCaption(get_handle(), (HDC)(dynamic_cast<::android::graphics * >(pgraphics))->get_os_data(), lprc, uFlags); }
    ...
    ::user::interaction* window::SetActiveWindow()
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::SetActiveWindow(get_handle())); }
    ::ca2::window * PASCAL window::GetCapture()
      { return ::android::window::from_handle(::GetCapture()); }
   ...
   ::user::interaction * window::set_capture(::user::interaction* pinterface)
   {
      ...
      return dynamic_cast < ::ca2::window * > (::android::window::from_handle(::SetCapture(get_handle())));
   }

    ::ca2::window * PASCAL window::GetFocus()
      { return ::android::window::from_handle(::GetFocus()); }
    ::ca2::window * window::SetFocus()
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::SetFocus(get_handle())); }
    ::ca2::window * PASCAL window::GetDesktopWindow()
...
int window::GetCheckedRadioButton(int nIDFirstButton, int nIDLastButton)
{
   ...
   return 0; // invalid ID
    ...
    ::ca2::window * window::GetNextDlgGroupItem(::ca2::window * pWndCtl, BOOL bPrevious) const
    {
       ASSERT(::IsWindow(get_handle()));
       return ::android::window::from_handle(::GetNextDlgGroupItem(get_handle(), (oswindow) pWndCtl->get_os_data(), bPrevious));
    }

    ::ca2::window * window::GetNextDlgTabItem(::ca2::window * pWndCtl, BOOL bPrevious) const
    {
       ASSERT(::IsWindow(get_handle()));
       return ::android::window::from_handle(::GetNextDlgTabItem(get_handle(), (oswindow) pWndCtl->get_os_data(), bPrevious));
    }
    ...
    int window::ScrollWindowEx(int dx, int dy,
      ...
      ::ca2::rgn* prgnUpdate, LPRECT lpRectUpdate, UINT flags)
    ...
    ::ca2::window * window::ChildWindowFromPoint(POINT point)
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::ChildWindowFromPoint(get_handle(), point)); }
    ::ca2::window * window::ChildWindowFromPoint(POINT point, UINT nFlags)
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::ChildWindowFromPointEx(get_handle(), point, nFlags)); }
    ::ca2::window * PASCAL window::FindWindow(const char * lpszClassName, const char * lpszWindowName)
      { return ::android::window::from_handle(::FindWindow(lpszClassName, lpszWindowName)); }
    ::ca2::window * window::FindWindowEx(oswindow hwndParent, oswindow hwndChildAfter, const char * lpszClass, const char * lpszWindow)
    ...
    ::user::interaction* window::GetNextWindow(UINT nFlag)
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::GetNextWindow(get_handle(), nFlag)); }
    ::user::interaction* window::GetTopWindow()
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::GetTopWindow(get_handle())); }
    ::user::interaction* window::GetWindow(UINT nCmd)
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::GetWindow(get_handle(), nCmd)); }
    ::user::interaction* window::GetLastActivePopup()
      { ASSERT(::IsWindow(get_handle())); return ::android::window::from_handle(::GetLastActivePopup(get_handle())); }

    ::ca2::window * window::SetParent(::ca2::window * pWndNewParent)
    {
       ASSERT(::IsWindow(get_handle()));
       return ::android::window::from_handle(::SetParent(get_handle(), (oswindow) pWndNewParent->get_os_data()));
    }

    ::ca2::window * PASCAL window::WindowFromPoint(POINT point)
      { return ::android::window::from_handle(::WindowFromPoint(point)); }
   ...
   #pragma pop_macro("MessageBox")
    ...
    ::ca2::window * PASCAL window::GetOpenClipboardWindow()
      { return ::android::window::from_handle(::GetOpenClipboardWindow()); }
    ::ca2::window * PASCAL window::GetClipboardOwner()
      { return ::android::window::from_handle(::GetClipboardOwner()); }
    ::ca2::window * PASCAL window::GetClipboardViewer()
    ...
    ::ca2::window * PASCAL window::GetForegroundWindow()
   ...
   // Win4
    ...
    void window::Print(::ca2::graphics * pgraphics, DWORD dwFlags) const
      { ASSERT(::IsWindow(get_handle())); const_cast < window * > (this)->SendMessage(WM_PRINT, (WPARAM)(dynamic_cast<::android::graphics * >(pgraphics))->get_os_data(), dwFlags); }
    void window::PrintClient(::ca2::graphics * pgraphics, DWORD dwFlags) const
      { ASSERT(::IsWindow(get_handle())); const_cast < window * > (this)->SendMessage(WM_PRINTCLIENT, (WPARAM)(dynamic_cast<::android::graphics * >(pgraphics))->get_os_data(), dwFlags); }
   ...
   // Default message ::collection::map implementations
    void window::OnActivateApp(BOOL, DWORD)
      { Default(); }
    void window::OnActivate(UINT, ::ca2::window *, BOOL)
      { Default(); }
    ...
    void window::OnContextMenu(::ca2::window *, point)
      { Default(); }
    int window::OnCopyData(::ca2::window *, COPYDATASTRUCT*)
      { return (int)Default(); }
    ...
    void window::OnMButtonUp(UINT, point)
      { Default(); }
    int window::OnMouseActivate(::ca2::window *, UINT, UINT)
      { return (int)Default(); }
    ...
    void window::OnAskCbFormatName(__in UINT nMaxCount, __out_ecount_z(nMaxCount) LPTSTR pszName)
   {
    ...
    UINT window::OnGetDlgCode()
      { return (UINT)Default(); }
    void window::OnMDIActivate(BOOL, ::ca2::window *, ::ca2::window *)
      { Default(); }
...
*/
  ...
  /*  void CMDIFrameWnd::MDIActivate(::user::interaction* pWndActivate)
   ...
   oswindow PASCAL window::GetSafeOwner_(oswindow hParent, oswindow* pWndTop)
   {
      ...
      if (hWnd == NULL)
      {
   /* trans      frame_window* pFrame = commandroid_target::GetRoutingFrame_();
         if (pFrame != NULL)
   ...
   CLASS_DECL_ANDROID LRESULT AfxCallWndProc(::user::interaction * pinteraction, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
   {
      _AFX_THREAD_STATE* pThreadState = _afxThreadState.get_data();
      ...
      ::ca2::smart_pointer < ::user::android::message::base > spbase;
      ...
      catch(const ::ca2::exception & e)
      {
         if(App(pinteraction->m_papp).on_run_exception((::ca2::exception &) e))
            goto run;
         if(App(pinteraction->m_papp).final_handle_exception((::ca2::exception &) e))
            goto run;
...
//         TRACE(::ca2::trace::category_AppMsg, 0, "Warning: Uncaught exception in message_handler (returning %ld).\n", spbase->get_lresult());
   ...
   {
      SCAST_PTR(user::android::message::erase_bkgnd, perasebkgnd, pobj);
...
CTestCmdUI::CTestCmdUI(::ca2::application * papp) :
   ca2(papp),
   cmd_ui(papp)
{
...
/////////////////////////////////////////////////////////////////////////////
// Map from oswindow to ::ca2::window *
...
LRESULT CALLBACK AfxWndProc(oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
{
   ...
   return android::AfxCallWndProc(pWnd, hWnd, nMsg, wParam, lParam);
}

// always indirectly accessed via AfxGetAfxWndProc
WNDPROC CLASS_DECL_ANDROID AfxGetAfxWndProc()
{
...
CLASS_DECL_ANDROID void AfxHookWindowCreate(::user::interaction * pWnd)
{
   ...
   if (pThreadState->m_hHookOldCbtFilter == NULL)
   {
      pThreadState->m_hHookOldCbtFilter = ::SetWindowsHookEx(WH_CBT,
         android::_AfxCbtFilterHook, NULL, ::GetCurrentThreadId());
      if (pThreadState->m_hHookOldCbtFilter == NULL)
   ...
   HCURSOR hCursor, HBRUSH hbrBackground, HICON hIcon)
{
   ...
   __STATIC void CLASS_DECL_ANDROID
_AfxHandleActivate(::ca2::window * pWnd, WPARAM nState, ::ca2::window * pWndOther)
{
   ASSERT(pWnd != NULL);
...
__STATIC BOOL CLASS_DECL_ANDROID
_AfxHandleSetCursor(::ca2::window * pWnd, UINT nHitTest, UINT nMsg)
{
   if (nHitTest == HTERROR &&
...
__STATIC BOOL CLASS_DECL_ANDROID _AfxRegisterWithIcon(WNDCLASS* pWndCls,
...
BOOL CLASS_DECL_ANDROID AfxEndDeferRegisterClass(LONG fToRegisterParam, const char ** ppszClass)
{
...
_AfxActivationWndProc(oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
{
   ...
   try
   {
      ...
      case WM_INITDIALOG:
         {
            DWORD dwStyle;
            rect rectOld;
            ::ca2::window * pWnd = ::android::window::from_handle(hWnd);
      ...
      case WM_ACTIVATE:
         _AfxHandleActivate(::android::window::from_handle(hWnd), wParam,
            ::android::window::from_handle((oswindow)lParam));
         break;

      case WM_SETCURSOR:
         bCallDefault = !_AfxHandleSetCursor(::android::window::from_handle(hWnd),
...
//      TRACE(::ca2::trace::category_AppMsg, 0, "Warning: Uncaught exception in _AfxActivationWndProc (returning %ld).\n",
  //       lResult);
      pe->Delete();
   }
...
BOOL CLASS_DECL_ANDROID AfxRegisterClass(WNDCLASS* lpWndClass)
{
   WNDCLASS wndcls;
