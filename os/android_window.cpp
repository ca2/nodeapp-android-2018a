...
CLASS_DECL_ANDROID void hook_window_create(sp(::user::interaction) pWnd);
CLASS_DECL_ANDROID bool unhook_window_create();
void CLASS_DECL_ANDROID __pre_init_dialog(
   sp(::user::interaction) pWnd, LPRECT lpRectOld, DWORD* pdwStyleOld);
void CLASS_DECL_ANDROID __post_init_dialog(
...
//      m_cairoWork = NULL;
  //    m_cairosurfaceWork = NULL;
   ...
   /*__STATIC bool CLASS_DECL_ANDROID __modify_style(oswindow hWnd, int32_t nStyleOffset,
...
//               pui->send_message(WM_MOUSELEAVE);
  ...
  /*    ASSERT(pResult != NULL);
   ...
   /* trans oswindow CLASS_DECL_ANDROID __get_parent_owner(sp(::user::interaction) hWnd)
   {
...
/*         if (hWndTop != NULL && ::IsWindowEnabled(hWndTop) && hWndTop != hWnd)
   ...
   CLASS_DECL_ANDROID LRESULT __call_window_procedure(sp(::user::interaction) pinteraction, oswindow hWnd, UINT nMsg, WPARAM wparam, LPARAM lparam)
   {
      ___THREAD_STATE* pThreadState = gen_ThreadState.get_data();
...
//WNDPROC CLASS_DECL_ANDROID __get_window_procedure()
//{
...
__STATIC void CLASS_DECL_ANDROID __pre_init_dialog(
   sp(::user::interaction) pWnd, LPRECT lpRectOld, DWORD* pdwStyleOld)
{
...
CLASS_DECL_ANDROID const char * __register_window_class(UINT nClassStyle,
...
//__STATIC bool CLASS_DECL_ANDROID __register_with_icon(WNDCLASS* pWndCls,
...
//bool CLASS_DECL_ANDROID __end_defer_register_class(LONG fToRegisterParam, const char ** ppszClass)
//{
...
//bool CLASS_DECL_ANDROID __register_class(WNDCLASS* lpWndClass)
//{
//   WNDCLASS wndcls;
