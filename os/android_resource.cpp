...
HINSTANCE CLASS_DECL_ANDROID vfxFindResourceHandle(const char * lpszName, const char * lpszType)
{
...
HINSTANCE CLASS_DECL_ANDROID vfxFindResourceHandle(const wchar_t * lpszName, const wchar_t * lpszType)
{
   ASSERT(lpszName != NULL);
   ASSERT(lpszType != NULL);
