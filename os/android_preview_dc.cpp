...
__STATIC long CLASS_DECL_ANDROID _AfxMultMultDivDiv(
...
::ca2::graphics_object* preview_dc::SelectStockObject(int nIndex)
{
   ...
   case DEFAULT_GUI_FONT:
      ...
      {
         ::ca2::graphics_object* pObject = ::android::graphics_object::from_handle(
   ...
   default:
      ...
      return ::android::graphics_object::from_handle(::SelectObject(get_handle2(), hObj));
   }
}
...
::ca2::font* preview_dc::SelectObject(::ca2::font* pFont)
{
   ...
   ::ca2::font* pOldFont = (::ca2::font*) ::android::graphics_object::from_handle(
...
__STATIC int CLASS_DECL_ANDROID _AfxComputeNextTab(int x, UINT nTabStops, LPINT lpnTabStops, int nTabOrigin, int nTabWidth)
{
   ENSURE(nTabWidth!=0);
...
HDC CLASS_DECL_ANDROID AfxCreateDC(HGLOBAL hDevNames, HGLOBAL hDevMode)
{
   if (hDevNames == NULL)
      return NULL;
