...
/*
   ...
   {
      ::ca2::window * pwnd = ::win::window::FromHandlePermanent((HWND) pdata);
      if(pwnd != NULL)
         return pwnd;
...
//         ASSERT(System.GetThread() == NULL);
         pThreadState->m_pCurrentWinThread = dynamic_cast < class ::win::thread * > (::ca2::thread_sp::m_p);
...
//      dynamic_cast < ::win::thread * > ((smart_pointer < ::ex2::application >::m_p->::ca2::thread_sp::m_p))->m_hThread = AfxGetThread()->m_hThread;
  //    dynamic_cast < ::win::thread * > ((smart_pointer < ::ex2::application >::m_p->::ca2::thread_sp::m_p))->m_nThreadID = AfxGetThread()->m_nThreadID;
      dynamic_cast < class ::win::thread * > (::ca2::thread_sp::m_p)->m_hThread      =  ::GetCurrentThread();
      dynamic_cast < class ::win::thread * > (::ca2::thread_sp::m_p)->m_nThreadID    =  ::GetCurrentThreadId();
