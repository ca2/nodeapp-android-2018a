...
namespace android
{
   ...
   application::application(::ca2::application * papp) :
      ca2(papp)
   {
      ::ca2::smart_pointer < ex2::application >::set_app(papp);
      ::ca2::thread_sp::create(papp);
      WIN_THREAD(smart_pointer < ::ca2::thread >::m_p)->m_pAppThread = this;
...
//      m_pCmdInfo = NULL;
   ...
   void application::_001ParseCommandLine(::ca2::command_line& rCmdInfo)
   {
      ...
      int iStart = 1;
      if(::ca2::str::ends(::ca2::international::unicode_to_utf8(m_argv[0]), "app.exe"))
         iStart++;
      ...
      for (int i = iStart; i < m_argc; i++)
      {
         ...
         string strParam;
         ::ca2::international::unicode_to_utf8(strParam, pszParam);
         if(::ca2::str::begins_ci(strParam, "http://")
        || ::ca2::str::begins_ci(strParam, "https://"))
         {
            ::ca2::international::UnicodeToMultiByte(28591, strParam, pszParam);
            strParam = System.url().url_decode(strParam);
            /*wstring wstrParam = ::ca2::international::utf8_to_unicode(strParam);
            ::ca2::international::unicode_to_utf8(strParam, wstrParam);*/
         }
         rCmdInfo.ParseParam(strParam, bFlag, bLast);
      }

      string strCmdLine;
      ::ca2::international::unicode_to_utf8(strCmdLine, lpwstr);
      ...
      if(rCmdInfo.m_varQuery.has_property("uri"))
      {
         ...
         if(rCmdInfo.m_nShellCommand == ::ca2::command_line::FileNew)
            rCmdInfo.m_nShellCommand = ::ca2::command_line::FileOpen;
      }
      if(rCmdInfo.m_nShellCommand == ::ca2::command_line::FileOpen)
      {
         rCmdInfo.m_varQuery["show_platform"] = 1;
      }
   }

   bool application::_001ProcessShellCommand(::ca2::command_line & commandline)
   {
      bool bResult = true;
      switch (commandline.m_nShellCommand)
      {
      case ::ca2::command_line::FileNew:
         request(::ca2::g_emptyconst, commandline.m_varQuery);
      ...
      case ::ca2::command_line::FileOpen:
      ...
      case ::ca2::command_line::FilePrintTo:
      case ::ca2::command_line::FilePrint:
...
//         m_pcmdinfo = &rCmdInfo;
  ...
  //       m_pcmdinfo = NULL;
      ...
      case ::ca2::command_line::FileDDE:
//         m_pcmdinfo = (::ca2::command_line*)System.m_nCmdShow;
         System.m_nCmdShow = SW_HIDE;
         break;

         // If we've been asked to unregister, unregister and then terminate
      case ::ca2::command_line::AppUnregister:
         {
   ...
   {
      ::ca2::smart_pointer<::ex2::application>::m_p->_001OnFileNew(NULL);
   }

   ::document * application::_001OpenDocumentFile(var varFile)
   {
      return ::ca2::smart_pointer<::ex2::application>::m_p->_001OpenDocumentFile(varFile);
   }
   ...
   void application::_001EnableShellOpen()
   {
      ...
      m_atomApp = ::GlobalAddAtomW(::ca2::international::utf8_to_unicode(m_pszExeName));
   ...
   {
      WIN_THREAD(::ca2::smart_pointer < ::ca2::thread >::m_p)->LockTempMaps();
   }

   BOOL application::UnlockTempMaps(BOOL bDeleteTemp)
   {
      return WIN_THREAD(::ca2::smart_pointer < ::ca2::thread >::m_p)->UnlockTempMaps(bDeleteTemp);
   }
...
/*      try
   ...
   #endif
         AfxLockTempMaps(::ca2::smart_pointer < ::ex2::application >::m_p);
         AfxUnlockTempMaps(::ca2::smart_pointer < ::ex2::application >::m_p, -1);
      }
...
//            __MODULE_THREAD_STATE* pModuleThreadState = AfxGetModuleThreadState();
   ...
   {
      ::android::thread::construct(pfnThreadProc, pParam);
   }

   void * application::get_os_data()
   {
      return ::android::thread::get_os_data();
   }

   int_ptr application::get_os_int()
   {
      return ::android::thread::get_os_int();
   }
   ...
   {
      return ::android::thread::Begin(nPriority, nStackSize, dwCreateFlags, lpSecurityAttrs);
   }

   BOOL application::CreateThread(DWORD dwCreateFlags, UINT nStackSize,
                                  LPSECURITY_ATTRIBUTES lpSecurityAttrs)
   {
      return ::android::thread::CreateThread(dwCreateFlags, nStackSize, lpSecurityAttrs);
   }
   ...
   {
      return ::android::thread::GetThreadPriority();
   }
   BOOL application::SetThreadPriority(int nPriority)
   {
      return ::android::thread::SetThreadPriority(nPriority);
   }

   // Operations
   DWORD application::SuspendThread()
   {
      return ::android::thread::SuspendThread();
   }
   DWORD application::ResumeThread()
   {
      return ::android::thread::ResumeThread();
   }
   BOOL application::PostThreadMessage(UINT message, WPARAM wParam, LPARAM lParam)
   {
      return ::android::thread::PostThreadMessage(message, wParam, lParam);
   }
   bool application::post_message(::user::interaction * pguie, UINT message, WPARAM wParam, LPARAM lParam)
   {
      return ::android::thread::post_message(pguie, message, wParam, lParam);
   }

   bool application::PreInitInstance()
   {
      return ::android::thread::PreInitInstance();
   }
   ...
   {
      return ::android::thread::on_run_exception(e);
   }
   ...
   {
      return ::android::thread::initialize_instance();
   }

   ::user::android::message::e_prototype application::GetMessagePrototype(UINT uiMessage, UINT uiCode)
   {
      return ::android::thread::GetMessagePrototype(uiMessage, uiCode);
   }

   // running and idle processing
   int application::run()
   {
      return ::android::thread::run();
   }
   BOOL application::pre_translate_message(::ca2::signal_object * pobj)
   {
      return ::android::thread::pre_translate_message(pMsg);
   }
   BOOL application::pump_message()    // low level message pump
   {
      return ::android::thread::pump_message();
   }
   BOOL application::on_idle(LONG lCount) // return TRUE if more idle processing
   {
      return ::android::thread::on_idle(lCount);
   }
   BOOL application::is_idle_message(MSG* pMsg)  // checks for special messages
   {
      return ::android::thread::is_idle_message(pMsg);
   }
*/
   bool application::process_initialize()
   {
      if(::ca2::smart_pointer < ex2::application > ::m_p->is_system())
      {
   ...
   {
      WIN_THREAD(smart_pointer < ::ca2::thread >::m_p)->m_ptimera = new ::user::interaction::timer_array;
      WIN_THREAD(smart_pointer < ::ca2::thread >::m_p)->m_puiptra = new user::LPWndArray;

      WIN_THREAD(smart_pointer < ::ca2::thread >::m_p)->m_ptimera->m_papp = ::ca2::smart_pointer < ::ex2::application >::m_p;
      WIN_THREAD(smart_pointer < ::ca2::thread >::m_p)->m_puiptra->m_papp = ::ca2::smart_pointer < ::ex2::application >::m_p;

      WIN_THREAD(smart_pointer < ::ca2::thread >::m_p)->set_run();
      return true;
   }
   ...
   int application::exit_instance() // default will 'delete this'
   {
      ...
      ::ca2::thread_sp::m_p->set_os_data(NULL);

      WIN_THREAD(::ca2::thread_sp::m_p)->m_bRun = false;
      WIN_THREAD(::ca2::smart_pointer<::ex2::application>::m_p->::ca2::thread_sp::m_p)->m_bRun = false;

      int iRet = ::::ca2::application::exit_instance();

      //::ca2::smart_pointer<::ex2::application>::destroy();
...
/*
   ...
   {
      return   ::android::thread::ProcessWndProcException(e, pMsg);
   }
   ...
   {
      return  ::android::thread::ProcessMessageFilter(code, lpMsg);
   }
   ...
   {
      return ::android::thread::GetMainWnd();
   }
   ...
   {
      ::android::thread::assert_valid();
   }

   void application::dump(dump_context & dumpcontext) const
   {
      ::android::thread::dump(dumpcontext);
   }

   #endif
   void application::CommonConstruct()
   {
      ::android::thread::CommonConstruct();
   }
   void application::Delete()
   {
      ::android::thread::Delete();
   }
   // 'delete this' only if m_bAutoDelete == TRUE

   BOOL application::DispatchThreadMessageEx(MSG* msg)  // helper
   {
      return ::android::thread::DispatchThreadMessageEx(msg);
   }*/

   ::ca2::graphics * application::graphics_from_os_data(void * pdata)
   {
      return ::android::graphics::from_handle((HDC) pdata);
   }
...
//         ASSERT(System.GetThread() == NULL);
         pThreadState->m_pCurrentWinThread = dynamic_cast < class ::android::thread * > (::ca2::thread_sp::m_p);
...
//      dynamic_cast < ::android::thread * > ((smart_pointer < ::ex2::application >::m_p->::ca2::thread_sp::m_p))->m_hThread = AfxGetThread()->m_hThread;
  //    dynamic_cast < ::android::thread * > ((smart_pointer < ::ex2::application >::m_p->::ca2::thread_sp::m_p))->m_nThreadID = AfxGetThread()->m_nThreadID;
      dynamic_cast < class ::android::thread * > (::ca2::thread_sp::m_p)->m_hThread      =  ::GetCurrentThread();
      dynamic_cast < class ::android::thread * > (::ca2::thread_sp::m_p)->m_nThreadID    =  ::GetCurrentThreadId();


   }

   ::ca2::window * application::FindWindow(const char * lpszClassName, const char * lpszWindowName)
   {
   ...
   bool application::set_main_init_data(void * pdata)
   {
      ...
      if(m_pmaininitdata != NULL && ::ca2::smart_pointer < ::ex2::application >::m_p->is_system())
      {
