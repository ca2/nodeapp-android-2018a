...
namespace android
{
   ...
   {
      ASSERT(get_handle1() != NULL); return ::android::window::from_handle(::WindowFromDC(get_handle1()));
   }
   ...
   BOOL graphics::CreateCompatibleDC(::ca2::graphics * pgraphics)
   {
      ...
      {
         return Attach(::CreateCompatibleDC((HDC)(dynamic_cast<::android::graphics * >(pgraphics))->get_handle1()));
      }
   }
   ...
   BOOL graphics::BitBlt(int x, int y, int nWidth, int nHeight, ::ca2::graphics * pgraphicsSrc, int xSrc, int ySrc, DWORD dwRop)
   {
      if(get_handle1() == NULL)
         return FALSE;
   ...
   BOOL graphics::StretchBlt(int x, int y, int nWidth, int nHeight, ::ca2::graphics * pgraphicsSrc,
   ...
   str, (int)str.get_length(), nTabPositions, lpnTabStopPositions); }
   BOOL graphics::GrayString(::ca2::brush* pBrush,
...
#pragma pop_macro("GetTextMetrics")
   ...
   BOOL graphics::MaskBlt(int x, int y, int nWidth, int nHeight, ::ca2::graphics * pgraphicsSrc,
      int xSrc, int ySrc, ::ca2::bitmap& maskBitmap, int xMask, int yMask, DWORD dwRop)
   ...
   BOOL graphics::PlgBlt(LPPOINT lpPoint, ::ca2::graphics * pgraphicsSrc, int xSrc, int ySrc,
   ...
   { ASSERT(get_handle2() != NULL); return ::android::pen::from_handle(get_app(), (HPEN)::GetCurrentObject(get_handle2(), OBJ_PEN)); }
   ::ca2::brush* graphics::GetCurrentBrush() const
   { ASSERT(get_handle2() != NULL); return ::android::brush::from_handle(get_app(), (HBRUSH)::GetCurrentObject(get_handle2(), OBJ_BRUSH)); }
   ::ca2::palette* graphics::GetCurrentPalette() const
   { ASSERT(get_handle2() != NULL); return ::android::palette::from_handle(get_app(), (HPALETTE)::GetCurrentObject(get_handle2(), OBJ_PAL)); }
   ::ca2::font* graphics::GetCurrentFont() const
   { ASSERT(get_handle2() != NULL); return ::android::font::from_handle(get_app(), (HFONT)::GetCurrentObject(get_handle2(), OBJ_FONT)); }
   ::ca2::bitmap* graphics::GetCurrentBitmap() const
   { ASSERT(get_handle2() != NULL); return ::android::bitmap::from_handle(get_app(), (HBITMAP)::GetCurrentObject(get_handle2(), OBJ_BITMAP)); }
   ...
   BOOL graphics::TransparentBlt(int xDest, int yDest, int nDestWidth,
      int nDestHeight, ::ca2::graphics * pgraphicsSrc, int xSrc, int ySrc, int nSrcWidth,
...
#define HIMETRIC_INCH   2540    // HIMETRIC units per inch
   ...
   ::ca2::brush* PASCAL graphics::GetHalftoneBrush(::ca2::application * papp)
   {
      ...
      return ::android::brush::from_handle(papp, _afxHalftoneBrush);
   }

   void graphics::DrawDragRect(LPCRECT lpRect, SIZE size,
      LPCRECT lpRectLast, SIZE sizeLast, ::ca2::brush* pBrush, ::ca2::brush* pBrushLast)
   {
   ...
   ::ca2::graphics * PASCAL ::android::graphics::from_handle(HDC hDC)
   {
      hdc_map* pMap = afxMapHDC(TRUE); //create ::collection::map if not exist
      ASSERT(pMap != NULL);
      ::ca2::graphics * pgraphics = (::ca2::graphics *)pMap->from_handle(hDC);
      ASSERT(pgraphics == NULL || (dynamic_cast<::android::graphics * >(pgraphics))->get_handle1() == hDC);
      return pgraphics;
   }
   ...
   {
      return ::android::graphics_object::from_handle(papp, ::SelectObject(hDC, h));
   }
   ...
   ::ca2::graphics_object* graphics::SelectStockObject(int nIndex)
   {
      ...
      return ::android::graphics_object::from_handle(get_app(), hOldObj);
   }
   ...
   ::ca2::pen* graphics::SelectObject(::ca2::pen* pPen)
   {
      ...
      return dynamic_cast < pen * > (::android::graphics_object::from_handle(get_app(), hOldObj));
   }
   ...
   ::ca2::brush* graphics::SelectObject(::ca2::brush* pBrush)
   {
      ...
      return dynamic_cast < ::ca2::brush * > (::android::graphics_object::from_handle(get_app(), hOldObj));
   }
   ...
   ::ca2::font* graphics::SelectObject(::ca2::font* pFont)
   {
      ...
      return dynamic_cast < ::ca2::font * > (::android::graphics_object::from_handle(get_app(), hOldObj));
   }

   int graphics::SelectObject(::ca2::rgn* pRgn)
   {
   ...
   {
      return dynamic_cast < ::ca2::palette * > (::android::graphics_object::from_handle(get_app(), ::SelectPalette(get_handle1(), (HPALETTE)pPalette->get_os_data(), bForceBackground)));
   }
   ...
   int graphics::SelectClipRgn(::ca2::rgn* pRgn)
   {
      int nRetVal = ERROR;
      if(get_handle1() != NULL && get_handle1() != get_handle2())
   ...
   int graphics::SelectClipRgn(::ca2::rgn* pRgn, int nMode)
   {
      ASSERT(get_handle1() != NULL);
      int nRetVal = ERROR;
      if (get_handle1() != get_handle2())
      ...
      HANDLETABLE* pHandleTable, METARECORD* pMetaRec, int nHandles, LPARAM lParam)
   {
      ...
      case META_SETMAPMODE:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetMapMode((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWEXT:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetWindowExt(
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWORG:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetWindowOrg(
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTEXT:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetViewportExt(
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTORG:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetViewportOrg(
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEWINDOWEXT:
         (dynamic_cast<::android::graphics * >(pgraphics))->ScaleWindowExt(
            (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEVIEWPORTEXT:
         (dynamic_cast<::android::graphics * >(pgraphics))->ScaleViewportExt(
            (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_OFFSETVIEWPORTORG:
         (dynamic_cast<::android::graphics * >(pgraphics))->OffsetViewportOrg(
            (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SAVEDC:
         (dynamic_cast<::android::graphics * >(pgraphics))->SaveDC();
         break;
      case META_RESTOREDC:
         (dynamic_cast<::android::graphics * >(pgraphics))->RestoreDC((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETBKCOLOR:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetBkColor(*(UNALIGNED COLORREF*)&pMetaRec->rdParm[0]);
         break;
      case META_SETTEXTCOLOR:
         (dynamic_cast<::android::graphics * >(pgraphics))->SetTextColor(*(UNALIGNED COLORREF*)&pMetaRec->rdParm[0]);
         break;
      ...
      case META_SELECTOBJECT:
         {
            ...
            if (nObjType == 0)
            {
               ...
               HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::android::graphics * >(pgraphics))->get_handle1(), hStockFont);
               HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::android::graphics * >(pgraphics))->get_handle1(), hObject);
               if (hObjOld == hStockFont)
               {
                  // got the stock object back, so must be selecting a font
                  (dynamic_cast<::android::graphics * >(pgraphics))->SelectObject(::android::font::from_handle(pgraphics->get_app(), (HFONT)hObject));
                  break;  // don't play the default record
               }
               else
               {
                  // didn't get the stock object back, so restore everything
                  ::SelectObject((dynamic_cast<::android::graphics * >(pgraphics))->get_handle1(), hFontOld);
                  ::SelectObject((dynamic_cast<::android::graphics * >(pgraphics))->get_handle1(), hObjOld);
               }
   ...
   int graphics::DrawTextEx(LPTSTR lpszString, int nCount, LPRECT lpRect, UINT nFormat, LPDRAWTEXTPARAMS lpDTParams)
   {
      ...
      ASSERT((nFormat & (DT_END_ELLIPSIS | DT_MODIFYSTRING)) != (DT_END_ELLIPSIS | DT_MODIFYSTRING));
      ASSERT((nFormat & (DT_PATH_ELLIPSIS | DT_MODIFYSTRING)) != (DT_PATH_ELLIPSIS | DT_MODIFYSTRING));
      wstring wstr = ::ca2::international::utf8_to_unicode(lpszString);
...
*/
   ...
   // resource failure
   void CLASS_DECL_ANDROID AfxThrowResourceException()
   {
      throw resource_exception();
   }

   // ::fontopus::user alert
   void CLASS_DECL_ANDROID AfxThrowUserException()
   {
