...
namespace win
{
   ...
   draw_dib::draw_dib(::ca2::application * papp) :
      ca2(papp)
   {
      m_hdrawdib = NULL;
   }
   ...
   BOOL draw_dib::Begin (::ca2::graphics * pdc, int dxDest, int dyDest,
   ...
   BOOL draw_dib::draw (::ca2::graphics * pdc, int xDst, int yDst,
   ...
   BOOL draw_dib::draw (::ca2::dib *dib, ::ca2::graphics * pdc, int xDst, int yDst,
   ...
   ::ca2::palette * draw_dib::get_palette ()
   {
      return ::win::palette::from_handle(get_app(), DrawDibGetPalette ( m_hdrawdib ));
   }

   BOOL draw_dib::set_palette (  ::ca2::palette * ppal)
   {
      return DrawDibSetPalette ( m_hdrawdib, (HPALETTE) ppal->get_os_data()  );
   }

   BOOL draw_dib::ChangePalette ( ::ca2::draw_dib * pdd, int iStart, int iLen, LPPALETTEENTRY lppe )
   {
      UNREFERENCED_PARAMETER(pdd);
      return DrawDibChangePalette ( m_hdrawdib, iStart, iLen, lppe );
   }

   UINT draw_dib::Realize ( ::ca2::graphics * pdc, BOOL fBackground )
   {
